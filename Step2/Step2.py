...
def batchStore():
    ...
    f = open(filename, 'wb')
    pickle.dump({'Batch Number:' :Batch.BatchNo,'Component Type:': compTypeChoice, 'Fitment Type:': fitTypeChoice,'Number of components:': noOfComp,'Serial Numbers:': SerialNumbers}, f)
...
while True:
    ...
    userChoice = input('Please Press the key 1, 2, 3, 4 or 5:')
    newln()
